...
def node_betweenness(input_graph_path: str, 
                ...
                **kwargs) -> int:
    """Create :class:`NodeBetweenness <biobb_dyna.dyna.analysis.node_betweenness.NodeBetweenness>` class and execute the :meth:`launch() <biobb_dyna.dyna.analysis.node_betweenness.NodeBetweenness.launch>` method."""
